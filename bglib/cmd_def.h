...
enum ble_parameter_types
{
    ...
    ble_msg_parameter_aes_key_128=12,
    ble_msg_parameter_uuid_128=12,
    ble_msg_parameter_sl_bt_uuid_64_t=13,
    ble_msg_parameter_int64_t=14,
    ble_msg_parameter_uint64_t=15
};
...
enum ble_msg_idx
{
	...
	ble_evt_hardware_radio_error_idx =267,
	ble_evt_dfu_boot_idx =268
};
...
/**This event is produced when the radio hardware error appears**/
