...
static const struct ble_msg  apis[]={
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_evt|0x0,0x0,ble_cls_hardware,ble_evt_hardware_radio_error_id}, 0x0, 	(ble_cmd_handler)ble_evt_hardware_radio_error},
...
static const struct ble_msg* const ble_class_hardware_evt_handlers[]=
{
	...
	&apis[ble_evt_hardware_radio_error_idx],
};
...
const struct ble_class_handler_t ble_class_evt_handlers[ble_cls_last]=
{
	...
	{ble_class_hardware_evt_handlers,5},
	{NULL,0},
